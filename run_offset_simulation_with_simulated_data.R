...
user_simulated_ecology_params = initialise_user_feature_params()
...
current_simulation_folder = find_current_run_folder(user_global_params$simulation_folder, file_placeholder_width = 3)
